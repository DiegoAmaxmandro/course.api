...
import com.course.clients.AuthUserClients;
import com.course.dtos.SubscriptionDto;
import com.course.dtos.UserDto;
...
public class CourseUserController {
    ...
    @Autowired
    AuthUserClients authUserClients;
    ...
    public ResponseEntity<Page<UserDto>> getAllUsersByCourse(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(authUserClients.getAllUsersByCourse(courseId, pageable));
    }
    ...
    public ResponseEntity<Object> saveSubscriptionUserInCourse(@PathVariable(value = "courseId") UUID courseId,
        ...
        try {
            responseUser = authUserClients.getOneUserById(subscriptionDto.getUserId());
